		...
		app.factory('webPageFactory',function($http){
			...
			factory_service.addDetails = function(user_obj){
				...
				return $http({
					...
					method: 'POST',
					url: 'http://localhost:8080/myWebApplication/addUser',
					data: user_obj
				});
			...
			factory_service.removeDetails = function(user_obj){
				...
				return $http({
					...
					method: 'POST',
					url: 'http://localhost:8080/myWebApplication/deleteUser',
					data: user_obj
			...
			factory_service.updateDetails = function(user_obj){
				...
				return $http({
					...
					method: 'POST',
					url: 'http://localhost:8080/myWebApplication/updateUser',
					data: user_obj
			...
			factory_service.getAllUsers = function(user_obj){
				...
				return $http({
					...
					method: 'GET',
					url: 'http://localhost:8080/myWebApplication/getAllUsers',
